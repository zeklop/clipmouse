...
| «Не засыпать» (кофеин) | правый клик по иконке · строка Awake в меню (пилюли 1–5 ч, стоп) |
...
Меню: история → строка Awake (пилюли 1–5 ч, стоп, «Другие интервалы ▸»; клик не закрывает меню) → Snippets (вставка + «Manage Snippets…») → Search… → Settings → Quit.
...
Да: правый клик по иконке — тумблер, а строка Awake в меню — пилюли 1–5 ч одним кликом (меню не закрывается, остаток тикает прямо в строке), таймеры 5–30 минут и «Бессрочно» — под «Другими интервалами», порог батареи, остаток времени — в оранжевых кольцах. Для скриптов есть URL-схема `clipmouse://caffeine/activate?seconds=N`.
...
Фазы 0–6 реализованы; версия 0.2.0 принесла окно настроек с табами, инлайн-редактирование сниппетов и защиту временных секретов; 0.2.1 — строку Awake с пилюлями 1–5 ч, стоп-пилюлей и живым отсчётом прямо в меню.

ClipMouse 0.2.1 — преемник ClipMenu 0.4.3 · Swift 6 · AppKit · 2026
